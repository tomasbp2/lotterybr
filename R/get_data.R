...
#' @param type select if you want the winners database or the results
...
#' megasena_ganhadores <- get_data(game= "megasena",type = "ganhadores")
#' megasena_ganhadores
#'
#' lotofacil_dezenas <- get_data(game= "lotofacil",type = "dezenas")
#' lotofacil_dezenas
#' }
#'
